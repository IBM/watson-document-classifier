# Watson Natural Language Understanding과 IBM Watson Studio를 활용하여 텍스트 분류 보강하기
...
* Watson Studio Object Storage를 사용하여 데이터 및 구성 파일에 접근합니다.
...
* 처리 결과를 JSON 형식으로 Watson Studio Object Storage에 저장합니다.
